...
function PoPCalCreateCalendarInstance()
{
	...
	if (!PopCalInstanceCreated())
	{
		...
		this.imgDir = "../../../Imagenes/Calendario/" // directory for images ... e.g. var imgDir="/img/"
...
//		this.styleLightBorder="border-style:solid;border-width:1px;border-color:#a0a0a0;"
		this.styleLightBorder="border-style:solid;border-width:1px;border-color:#8496C5;"
...
function PopCalConstructYear() 
{
	...
	if (!objPopCalendar.yearConstructed)
	{
		...
		if (longList)
		{
			sHTML += "<tr><td align='center' onmouseover='objPopCalendar.bShow=true;this.style.backgroundColor=\"#FFCC99\"' onmouseout='objPopCalendar.bShow=false;clearInterval(objPopCalendar.intervalID2);this.style.backgroundColor=\"\"' style='cursor:default;border-top:1px #a0a0a0 solid' onmousedown='clearInterval(objPopCalendar.intervalID2);objPopCalendar.intervalID2=setInterval(\"PopCalIncYear()\",15)' onmouseup='clearInterval(objPopCalendar.intervalID2)'><IMG id='popupSuperDownYear' SRC='"+objPopCalendar.imgDir+"down.gif' BORDER=0></td></tr>"
		}
