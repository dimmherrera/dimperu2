<%@ Page Language="VB" MasterPageFile="~/Modulos/Master/MasterPage.master" AutoEventWireup="false"
    CodeFile="VBProrroga.aspx.vb" Inherits="Modulos_Prorrogas_rightframe_archivos_VBProrrogas"
    Title="Visto Bueno Prorroga" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        ...
                        <table style="width: 100%; position: static; text-align: -moz-center" cellspacing="0">
                            ...
                            <tr>
                                <td class="Contenido" align="center">
                                    <table id="cliente_diarios" border="0" width="95%">
                                        <tr class="0">
                                            <%--Cliente--%>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                                <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="200">
                                                    <tr>
                                                        <td align="left" class="Cabecera">
                                                            <asp:CheckBox ID="CBX_Fechas" runat="server" AutoPostBack="True" Text="Fecha Solicitud"
                                                                CssClass="SubTitulos" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:TextBox ID="txt_FechaSolDesde" runat="server" CssClass="clsMandatorio" MaxLength="10"
                                                                                                Width="90px" AutoPostBack="True"></asp:TextBox>
                                                                                            <cc2:MaskedEditExtender ID="txt_FechaSolDesde_MaskedEditExtender" runat="server"
                                                                                                CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat=""
                                                                                                CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder=""
                                                                                                CultureTimePlaceholder="" Enabled="False" Mask="99/99/9999" MaskType="Date" TargetControlID="txt_FechaSolDesde">
                                                                                            </cc2:MaskedEditExtender>
                                                                                            <cc2:CalendarExtender ID="CalendarExtender1" runat="server" CssClass="radcalendar"
                                                                                                Enabled="False" FirstDayOfWeek="Monday" Format="dd-MM-yyyy" TargetControlID="txt_FechaSolDesde">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:TextBox ID="txt_FechaSolHasta" runat="server" CssClass="clsMandatorio" MaxLength="10"
                                                                                                Width="90px" AutoPostBack="True"></asp:TextBox>
                                                                                            <cc2:MaskedEditExtender ID="txt_FechaSolHasta_MaskedEditExtender" runat="server"
                                                                                                CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat=""
                                                                                                CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder=""
                                                                                                CultureTimePlaceholder="" Enabled="False" Mask="99/99/9999" MaskType="Date" TargetControlID="txt_FechaSolHasta">
                                                                                            </cc2:MaskedEditExtender>
                                                                                            <cc2:CalendarExtender ID="CalendarExtender" runat="server" CssClass="radcalendar"
                                                                                                Enabled="False" FirstDayOfWeek="Monday" Format="dd-MM-yyyy" TargetControlID="txt_FechaSolHasta">
                                                                                            </cc2:CalendarExtender>
                                                                                        </td>
                                                                                        <td>
                                                                                            &nbsp;
                                            ...
                                            <td valign="top">
                                                <table id="Table5" border="0" cellpadding="0" cellspacing="0" width="220">
                                                    <tr>
                                                        <td align="left" class="Cabecera">
                                                            <asp:CheckBox ID="Check_est" runat="server" AutoPostBack="True" CssClass="SubTitulos"
                                                                Text="Todos los estados de  solicitud" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="Contenido" style="height: 80px" valign="top">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td valign="top">
                                                                                    <asp:Label ID="Label44" runat="server" CssClass="Label" Text="Estado Solicitud"></asp:Label>
                                                                                </td>
                                                                                <td>
                                                                                    <cc2:MaskedEditExtender ID="MaskedEditExtender1" runat="server" CultureAMPMPlaceholder=""
                                                                                        CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder=""
                                                                                        CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder=""
                                                                                        Enabled="False" Mask="99/99/9999" MaskType="Date" TargetControlID="txt_FechaSolDesde">
                                                                                    </cc2:MaskedEditExtender>
                                                                                    <cc2:CalendarExtender ID="CalendarExtender2" runat="server" CssClass="radcalendar"
                                                                                        Enabled="False" FirstDayOfWeek="Monday" Format="dd-MM-yyyy" TargetControlID="txt_FechaSolDesde">
                                                                                    </cc2:CalendarExtender>
                                                                                    <asp:RadioButtonList ID="Rb_est" runat="server" CssClass="Label">
                ...
                <tr>
                    <td align="right">
                        ...
                        <asp:ImageButton ID="IB_Imprimir" onmouseover="this.src='../../../Imagenes/Botones/Boton_imprimir_in.gif';"
                            ...
                            ImageUrl="~/Imagenes/Botones/Boton_Imprimir_out.gif" AlternateText="Imprimir Liquidación de Prorroga"
                            OnClick="IB_Imprimir_Click"></asp:ImageButton>
                        <asp:ImageButton ID="IB_ValidaSolicitud" runat="server" AlternateText="Validar Solicitud de Prorroga"
                            ImageUrl="~/Imagenes/Botones/Boton_Aprobar_out.gif" onmouseout="this.src='../../../Imagenes/Botones/Boton_Aprobar_out.gif';"
                            onmouseover="this.src='../../../Imagenes/Botones/Boton_Aprobar_in.gif';" />
                        <asp:ImageButton ID="IB_Rechazarsolicitud" runat="server" AlternateText="Rechazar Solicitud de Prorroga"
                            ImageUrl="~/Imagenes/Botones/boton_rechazar_out.gif"
                            onmouseout="this.src='../../../Imagenes/Botones/boton_rechazar_out.gif';" onmouseover="this.src='../../../Imagenes/Botones/boton_rechazar_in.gif';" />
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="IB_ValidaSolicitud" />
            <asp:PostBackTrigger ControlID="IB_Rechazarsolicitud" />
        </Triggers>
    </asp:UpdatePanel>
