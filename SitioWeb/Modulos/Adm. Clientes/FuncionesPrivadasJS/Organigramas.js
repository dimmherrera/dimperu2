function NewOrganigrama(url,pWidth,pHeight,pLeft,pTop)
{	
...
function celClickDosOrganigrama(pTabla,pClass,jClass,sClass)

{
...

	{
...

		{
            ...
            window.document.forms[0].RutOrg.value = '';
	    ...
	    window.document.forms[0].RutOrg.value = rut;
	    ...
	    __doPostBack('ActOrganigrama', '');
	    return;
	    }
}

function openseleccionDosOrganigrama(grilla,url,pWidth,pHeight,pLeft,pTop)
{
var id;
