<%@ Page Language="VB" MasterPageFile="~/Modulos/Master/MasterPage.master" AutoEventWireup="false"
    CodeFile="IngClientes.aspx.vb" Inherits="IngCliente" Title="Mantención de Clientes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel runat="server" ID="Updatepanel_mclientes">
        <ContentTemplate>
            <table cellspacing="1" class="Contenido" cellpadding="0" width="100%" border="0">
                <tbody align="center">
                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" width="250">
                                                                <asp:DropDownList ID="DP_TipoCliente" runat="server" __designer:wfdid="w9" 
                                                                    CssClass="clsMandatorio" Width="200px" AutoPostBack="True" TabIndex="4">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="DP_Corasu" runat="server" AutoPostBack="true" 
                                                                    CssClass="clsMandatorio" Width="250px" TabIndex="2">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td align="right">
                                                                &nbsp;</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        <asp:TextBox ID="Txt_Nom_Bre" runat="server" CssClass="clsMandatorio" __designer:wfdid="w20"
                                                                            Width="560px" MaxLength="150" TabIndex="10"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width:250px">
                                                                        <asp:TextBox ID="Txt_Ape_Pat" runat="server" CssClass="clsMandatorio" __designer:wfdid="w24"
                                                                            Width="250px" MaxLength="50" TabIndex="11"></asp:TextBox>
                                                                    </td>
                                                                    <td align="right" width="100" >
                                                                        <asp:Label ID="Label9" runat="server" CssClass="Label" __designer:wfdid="w25" Text="F. Nacimiento"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="Txt_Fec_Nac" runat="server" CssClass="clsMandatorio" __designer:wfdid="w26"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="height: 28px">
                                                                        <asp:TextBox ID="Txt_Ape_Mat" runat="server" CssClass="clsMandatorio" __designer:wfdid="w29"
                                                                            Width="250px" MaxLength="50" TabIndex="12"></asp:TextBox>
                                                                    </td>
                                                                    <td align="right">
                                                    ...
                                                    <asp:View ID="dos" runat="server">
                                                        <table id="TablaJuridico" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="right" width="160">
                                                                        <asp:Label ID="Label11" runat="server" CssClass="Label" __designer:wfdid="w32" Text="Nombre / Razón Social Proveedor"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="Txt_Raz_Soc" runat="server" CssClass="clsMandatorio" __designer:wfdid="w33"
                                                                            Width="560px" MaxLength="150" TabIndex="15"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">
                                                                        <asp:Label ID="Label12" runat="server" CssClass="Label" __designer:wfdid="w34" Text="Fecha Constitución"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="Txt_Banca" runat="server" __designer:wfdid="w44" 
                                                                    CssClass="clsDisabled" MaxLength="25" ReadOnly="True" Width="248px"></asp:TextBox>
                                                            </td>
                                                             <td align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="Txt_Mai" runat="server" __designer:wfdid="w52" CssClass="clsTxt"
                                                                    MaxLength="50" Width="248px" TabIndex="18"></asp:TextBox>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="DP_Suc_Bco" runat="server" CssClass="clsMandatorio" _designer:wfdid="w98"
                                                                    Width="250px" MaxLength="70" AutoPostBack="True" TabIndex="35">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:DropDownList ID="DP_TipoTasa" runat="server" CssClass="clsTxt" 
                                                                    Width="100px" AutoPostBack="True" TabIndex="41">
                                                        ...
                                                        <tr>
                                                            <td style="width: 93px" align="right">
                                                                <asp:Label ID="Lbl_TipoTasa" runat="server" CssClass="Label" Text="T.E.A."></asp:Label>
                                                            </td>
                                                            <td align="left">
