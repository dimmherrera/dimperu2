<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AyudaCli.aspx.vb" Inherits="Modulos_Ayudas_AyudaCli" %>
            ...
            <table id="Table2" border="0" cellpadding="0" cellspacing="0" width="600px">
                ...
                <tr>
                    <td align="left" valign="top">
                        <div style="overflow: auto; height: 235px; position: static;width:600px">
                            <asp:GridView ID="GV_Clientes" runat="server" AutoGenerateColumns="False" CssClass="formatUltcell"
                            EnableSortingAndPagingCallbacks="True" EnableTheming="True" PageSize="8" Width="100%">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Selección" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="Img_Ver" runat="server" ImageUrl="~/Images/bt_sel.gif" ToolTip='<%# Eval("cli_idc") %>' OnClick="Img_Ver_Click"/>
                                    </ItemTemplate>
